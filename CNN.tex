...
\begin{document}
	...
	\newcommand{\drawcube}[5]{
		...
		\draw[gray,fill=cyan!5,opacity=\Opacity] (E) -- (F) -- (G) -- (H) -- cycle;% Back Face
		\draw[gray,fill=cyan!5,opacity=\Opacity] (D) -- (C) -- (G) -- (H) -- cycle;% Left Face
		\draw[gray,fill=cyan!5,opacity=\Opacity] (A) -- (D) -- (H) -- (E) -- cycle;% Bottom Face
		\draw[gray,fill=cyan!5,opacity=\Opacity] (A) -- (B) -- (F) -- (E) -- cycle;% Right Face
		\draw[gray,fill=cyan!5,opacity=\Opacity] (B) -- (C) -- (G) -- (F) -- cycle;% Top Face
		\draw[gray,fill=cyan!5,opacity=\Opacity] (A) -- (B) -- (C) -- (D) -- cycle;% Front Face   
	}
	...
	\pgfmathsetmacro{\offsetb}{150}%5
	\pgfmathsetmacro{\offsetc}{260}%5
	\pgfmathsetmacro{\offsetd}{360}%5
	\pgfmathsetmacro{\offsete}{450}%5
	\pgfmathsetmacro{\offsetf}{520}%5
	\pgfmathsetmacro{\offsetg}{575}%5
	\pgfmathsetmacro{\offseth}{645}%5
	\pgfmathsetmacro{\offseti}{725}%5
	\pgfmathsetmacro{\offsetj}{800}%5
	\pgfmathsetmacro{\offsetk}{875}%5
	\pgfmathsetmacro{\offsetl}{950}%5
	\pgfmathsetmacro{\offsetm}{930}%5
	
	\pgfmathsetmacro{\featang}{25}%4
	\pgfmathsetmacro{\featanga}{20}%4
	\pgfmathsetmacro{\featangb}{20}%4
	\pgfmathsetmacro{\featangc}{20}%4
	\pgfmathsetmacro{\featangd}{20}%4
	\pgfmathsetmacro{\featange}{20}%4
	\pgfmathsetmacro{\featangf}{20}%4
	\pgfmathsetmacro{\featangg}{20}%4
	\pgfmathsetmacro{\featangh}{20}%4
	\pgfmathsetmacro{\featangi}{20}%4
	\pgfmathsetmacro{\featangj}{20}%4
	\pgfmathsetmacro{\featangk}{20}%4
	\pgfmathsetmacro{\featangl}{20}%4
	\pgfmathsetmacro{\featangm}{20}%4
	...
	% \node[] at (-0.5,\fa/2) {512};
	% \node[] at (0,\fa+0.5) {4};
	\node[] at (\feata/2,-0.5) {(1536x1536x5)};
	\node[] at (\feata/2,\feata/2) {$Py(X)$};
